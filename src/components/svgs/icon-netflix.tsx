...
const NetFlixIcon = (props: SvgIconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" id="svg2" fill="#000" viewBox="-49.6 0 222 222" {...props}>
      ...
      <g id="layer1" transform="translate(12.495 6.756)">
        <g id="g4182">
          <g id="g5747" transform="translate(81.631 113.771) scale(.29074)">
            <path
              id="path4155"
              d="m-52.5-412.3-.3 168-.3 168-13.8-39v-.1l-17.9 374c17.6 49.6 27 76.1 27.1 76.2.1.1 10.1.7 22.2 1.3 36.6 1.8 82 5.7 116.5 10 8 1 14.8 1.5 15.3 1.1s.6-171.4.5-380.1l-.3-379.4h-149z"
              className="st0"
            />
            <path
              id="path4157"
            ...
            <path
              id="path5721"
              d="m-322-412.8 150.5 426.5v-.2l11.9 33.6C-93.5 234.2-58 334.6-57.8 334.8c.1.1 10.1.7 22.2 1.3 36.6 1.8 82 5.7 116.5 10 7.9 1 14.8 1.5 15.2 1.1L-53.1-76.4v.1l-13.8-39c-13.5-38.1-22.5-63.6-76.8-217-14.6-41.3-27-76.2-27.5-77.8l-1-2.8h-74.9l-74.9.1z"
              style={{
                fill: "#e50914",
              }}
            />
