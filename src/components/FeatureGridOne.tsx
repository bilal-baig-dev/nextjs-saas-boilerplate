import { CreditCard, Database, Fingerprint, Gauge, Layers, Mail, PanelTop, Rss, SquareLibrary } from "lucide-react";
import ButtonTimeSaved from "./common/ButtonTimeSaved";
              ...
              <Card key={index} className="flex flex-col  gap-4 px-5 py-7 dark:border-card transition-colors duration-250 rounded-2xl shadow-2xl">
                ...
                <Flex className="flex-col gap-6">
                  ...
                  <div className="flex justify-start items-center">
                    <ButtonTimeSaved text={Number(el.timeSaved)} />
                  </div>
                </Flex>
              </Card>
            );
